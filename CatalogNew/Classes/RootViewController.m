...
- (void)loadView {
    ...
    //PAGE MAIN
    twoPageCatalogView = [[TwoPageCatalogViewController alloc]
                          initWithNibName:@"TwoPageCatalogViewController" bundle:nil];
    twoPageCatalogView.current_left_page = 1;
    twoPageCatalogView.current_right_page = 2;
    ...
    //NEXT PAGE
    twoPageCatalogViewNext = [[TwoPageCatalogViewController alloc]
                            initWithNibName:@"TwoPageCatalogViewController" bundle:nil];
    twoPageCatalogViewNext.current_left_page = 3;
    twoPageCatalogViewNext.current_right_page = 4;
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController
{
    ...
    NSUInteger index = ((TwoPageCatalogViewController*) viewController).pageIndex;
//    NSLog(@"index: %d", index);
...
- (TwoPageCatalogViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    TwoPageCatalogViewController* dupa = [[TwoPageCatalogViewController alloc]
                         initWithNibName:@"TwoPageCatalogViewController" bundle:nil];
    dupa.current_left_page = (index*2)+1;
    dupa.current_right_page = (index*2)+2;
    
    
//    dupa.imageFile = self.pageImages[index];
//    dupa.titleText = self.pageTitles[index];
