...
- (void)initQCARInBackground
{
    ...
    @autoreleasepool {
        NSLog(@"initQCARInBackground");
        QCAR::setInitParameters(mQCARInitFlags, "9a22c7a97365450c886de1c77ea05ad5");
...
- (bool)startCamera:(QCAR::CameraDevice::CAMERA)camera viewWidth:(float)viewWidth andHeight:(float)viewHeight error:(NSError **)error
{
    ...
    _projectionMatrix = QCAR::Tool::getProjectionGL(cameraCalibration, 2.0f, 9000.0f);
    return YES;
}
