...
NSString * const BMPhotoAlbumLayoutAlbumTitleKind = @"AlbumTitle";


@interface BMPhotoAlbumLayout ()
...
@implementation BMPhotoAlbumLayout
@synthesize itemSize;
...
//    }
//    else{
        self.itemInsets = UIEdgeInsetsMake(35.0f, 35.0f, 5.0f, 5.0f);
...
//    self.collectionView setD
    ...
    for (NSInteger section = 0; section < sectionCount; section++) {
        ...
        for (NSInteger item = 0; item < itemCount; item++) {
            ...
            if (indexPath.item == 0) {
                UICollectionViewLayoutAttributes *titleAttributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:BMPhotoAlbumLayoutAlbumTitleKind withIndexPath:indexPath];
    ...
    newLayoutInfo[BMPhotoAlbumLayoutAlbumTitleKind] = titleLayoutInfo;
...
{
    return self.layoutInfo[BMPhotoAlbumLayoutAlbumTitleKind][indexPath];
}
